...
class PizzaKotlas(
    ...
    sicilianPizzaPrice,  tyroleanPizzaPrice), IDrink, IReceiptPhoto, ISauce
{
    ...
    val mustardSaucePrice = 30.0

    var ketchupSauceCount = 0
    var mustardSauceCount = 0
    ...
    override fun showStats() //base class func overridden
    {
        ...
        println("Купили баночек горчицы: $mustardSauceCount; на сумму ${mustardSaucePrice*mustardSauceCount} рублей")

        var sauceIncome = ketchupSaucePrice*ketchupSauceCount+mustardSauceCount*mustardSaucePrice
    ...
    override fun SauceSale()
    {
        ...
        if (readln()=="1")
        {
            ...
            {
                mustardSauceCount++
                println("Горчица будет стоить $mustardSaucePrice рублей")
                return
            }
